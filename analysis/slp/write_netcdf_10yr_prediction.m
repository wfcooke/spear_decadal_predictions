...
load slp_2024prediction_10yr.mat
...
fout=['psl_Amon_GFDL-SPEAR_LO_s2024Jan1st_' 'r' num2str(ensemble) 'i1p1f1' '_gn_climatology-1991-2020.nc'];

var_name='psl';
sst_for=slp_2024prediction_10yr(ensemble,:,:,:);
time=time;
ens=ensemble;
lat=lat;
lon=lon;
...
unit = 'hPa'; % for example of course
