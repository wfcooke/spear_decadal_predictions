...
for en=101:105
 ...
 for year=startyr:endyr
    ...
    sfile1=[file 'atmos.' num2str(year) '01' '-' num2str(year+9) '12' '.t_surf.nc'];   

      f=netcdf(sfile1,'nowrite');
         tt(1:120,:,:)=squeeze(f{'t_surf'}(:,:,:));
         lat=f{'lat'}(:);
         lon=f{'lon'}(:);
      close(f)  
   
   airt_2024_ens1_5(en-100,year-2023,:,:,:)=tt;
   clear tt
...
for en=101:105
 ...
 for year=startyr:endyr
   ...
   airt_2024_ens6_10(en-100,year-2023,:,:,:)=tt;
   clear tt
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
airt_2024(1:5,:,:,:,:)=airt_2024_ens1_5;
clear airt_2024_ens1_5

airt_2024(6:10,:,:,:,:)=airt_2024_ens6_10;
clear airt_2024_ens6_10
