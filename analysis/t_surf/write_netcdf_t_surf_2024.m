...
fout=['ts_Amon_GFDL-SPEAR_LO_Initialization_yr' num2str(newnum) '_10yr_prediction_r' num2str(ensemble) 'i1p1f1.nc'];

var_name='ts';
sst_for=airt_2024(ensemble,newnum-2023:newnum-2023,:,:,:);
