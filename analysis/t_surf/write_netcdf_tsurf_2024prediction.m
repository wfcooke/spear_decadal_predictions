...
load airt_2024prediction_10yr.mat
...
fout=['ts_Amon_GFDL-SPEAR_LO_s2024Jan1st_' 'r' num2str(ensemble) 'i1p1f1' '_gn_climatology-1991-2020.nc'];

var_name='ts';
sst_for=airt_2024prediction_10yr(ensemble,:,:,:);
time=time;
ens=ensemble;
lat=lat;
lon=lon;
